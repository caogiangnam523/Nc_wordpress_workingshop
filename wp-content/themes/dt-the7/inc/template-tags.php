 ...
 *
 */
function presscore_parce_query_for_front_page_categorizer( $query ) {
	...
	remove_action( 'parse_query', 'presscore_parce_query_for_front_page_categorizer' );

}
add_action( 'parse_query', 'presscore_parce_query_for_front_page_categorizer' );
