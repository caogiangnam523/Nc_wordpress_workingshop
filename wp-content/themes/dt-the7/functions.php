...
if ( ! function_exists( 'presscore_enqueue_scripts' ) ) :
	...
	function presscore_enqueue_scripts() {
		...
		// wp_enqueue_style( 'dt-prettyPhoto', $template_uri . '/js/plugins/pretty-photo/css/prettyPhoto.css', array(), $theme_version );
		...
		// wp_enqueue_script( 'dt-prettyPhoto', $template_uri . '/js/plugins/pretty-photo/js/jquery.prettyPhoto.js', array( 'jquery' ), $theme_version, true );
		...
		wp_localize_script( 'dt-plugins', 'dtLocal', array(
